...
app.layout = html.Div([
    # Header Section
    html.Div([
        html.Img(src='/assets/logo.png', style={'height': '80px', 'margin': '10px'}),
        html.H1("Mouse Memory Analysis Dashboard", 
    ...
    html.Div([
        ...
        dcc.Graph(id='adn-graph'),
    ], style={'width': '65%', 'display': 'inline-block', 'vertical-align': 'top', 'padding': '10px'}),

    html.Div([
        dcc.Graph(id='acc-interval-graph'),
        dcc.Graph(id='adn-interval-graph'),
    ], style={'width': '35%', 'display': 'inline-block', 'vertical-align': 'top', 'padding': '10px'})
